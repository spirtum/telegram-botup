...
def message_update_by_text(text):
    return BaseContext(Update.from_dict({'message': {'chat': {'first_name': USER_FIRST_NAME,
                                                              'id': USER_ID,
...
def callback_update_by_data(data):
    return BaseContext(Update.from_dict({'callback_query': {'chat_instance': '123',
                                                            'data': data,
                                                            'from': {'first_name': USER_FIRST_NAME,
                                                                     'id': USER_ID,
                                                                     'is_bot': False,
...
def inline_query_update_by_query(query):
    return BaseContext(Update.from_dict({'inline_query': {'from': {'first_name': USER_FIRST_NAME,
                                                                   'id': USER_ID,
                                                                   'is_bot': False,
                                                                   'language_code': 'en',
                                                                   'last_name': USER_LAST_NAME,
...
def chosen_inline_result_update():
    return BaseContext(Update.from_dict({'chosen_inline_result': {'from': {'first_name': USER_FIRST_NAME,
                                                                           'id': USER_ID,
                                                                           'is_bot': False,
                                                                           'language_code': 'en',
                                                                           'last_name': USER_LAST_NAME,
...
def edited_message_update_by_text(text):
    return BaseContext(Update.from_dict({'edited_message': {'chat': {'first_name': USER_FIRST_NAME,
                                                                     'id': USER_ID,
                                                                     'last_name': USER_LAST_NAME,
                                                                     'type': 'private',
                                                                     'username': USER_USERNAME},
...
def channel_post_update():
    return BaseContext(Update.from_dict({'channel_post': {'chat': {'id': CHANNEL_ID,
                                                                   'title': CHANNEL_TITLE,
                                                                   'type': 'channel'},
                                                          'date': 123,
                                                          'message_id': 2,
...
def edited_channel_post_update():
    return BaseContext(Update.from_dict({'edited_channel_post': {'chat': {'id': CHANNEL_ID,
                                                                          'title': CHANNEL_TITLE,
                                                                          'type': 'channel'},
                                                                 'date': 123,
                                                                 'edit_date': 124,
...
def animation_update():
    return BaseContext(Update.from_dict({'message': {'animation': {'duration': 3,
                                                                   'file_id': 'qwe',
                                                                   'file_name': 'giphy.mp4',
                                                                   'file_size': 253953,
                                                                   'file_unique_id': 'asd',
...
def audio_update():
    return BaseContext(Update.from_dict({'message': {'audio': {'duration': 187,
...
def new_chat_members_update():
    return BaseContext(Update.from_dict({'message': {'chat': {'id': GROUP_ID,
                                                              'title': GROUP_TITLE,
                                                              'type': 'group'},
                                                     'date': 123,
                                                     'from': {'first_name': USER_FIRST_NAME,
...
def poll_update():
    return BaseContext(Update.from_dict({'poll': {'id': '123',
                                                  'total_voter_count': 3,
                                                  'is_anonymous': True,
                                                  'type': 'regular',
...
def poll_answer_update():
    return BaseContext(Update.from_dict({'poll_answer': {'option_ids': [0],
                                                         'poll_id': '123',
...
def my_chat_member_update():
    return BaseContext(Update.from_dict({'my_chat_member': {'chat': {'all_members_are_administrators': True,
                                                                     'id': -123456789,
                                                                     'title': 'title',
                                                                     'type': 'group'},
                                                            'date': 1686856861,
